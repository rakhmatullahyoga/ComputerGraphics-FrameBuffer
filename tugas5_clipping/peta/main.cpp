...
int main(int argc, char const *argv[]) {
	...
	Object sumatra("sumatra.txt");
	sumatra.Draw(frame);
	Object jawa("jawa.txt");
	jawa.Draw(frame);
	Object kalimantan("kalimantan.txt");
	kalimantan.Draw(frame);
	Object sulawesi("sulawesi.txt");
	sulawesi.Draw(frame);
	//Object papua("papua.txt");
	//papua.Draw(frame);
	Object maluku("maluku.txt");
	maluku.Draw(frame);
	Object maluku2("maluku2.txt");
	maluku2.Draw(frame);
	Object maluku3("maluku3.txt");
	maluku3.Draw(frame);
	Object bali("bali.txt");
	bali.Draw(frame);
	Object lombok("lombok.txt");
	lombok.Draw(frame);
	Object ntb("ntb.txt");
	ntb.Draw(frame);
	Object ntt("ntt.txt");
